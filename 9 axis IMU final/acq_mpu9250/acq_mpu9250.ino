...
void loop()
{
  ...
  if (AGM.delt_t > 500)
  {
    if(SerialDebug)
    {
      ...
      Serial.print("X-Magneto rate: "); 
      Serial.print(AGM.mx);
      Serial.print(" degrees/sec ");
      
      Serial.print("Y-Magnetorate: ");
      Serial.print(AGM.my);
      Serial.print(" degrees/sec ");
      
      Serial.print("Z-Magneto rate: "); 
      Serial.print(AGM.mz);
      Serial.println(" degrees/sec");
    ...
    Serial.print("Temperature is ");  Serial.print(AGM.temperature, 2);
